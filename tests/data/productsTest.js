...
describe("Test suite: Clothing ", () => {
  ...
  it("getStartsUrl", () => {
    expect(clothing.getStartsUrl()).toEqual("images/ratings/rating-45.png");
  });
  it("getPrice", () => {
...
describe("Test suite : appliance", () => {
  ...
  it("gets the starts url", () => {
    expect(appliance.getStartsUrl()).toEqual("images/ratings/rating-50.png");
  });
